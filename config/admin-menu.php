...
return [
    'menu' => [
        ...
        [
            ...
            'sort' => 97,
            'children' => [
                [ 'title' => 'Overview', 'route' => 'admin.configuration.dashboard', 'permission' => 'configuration.view' ],
                [ 'title' => 'Configurations', 'route' => 'admin.configuration.index', 'permission' => 'configuration.view' ],
                [ 'title' => 'Feature Flags', 'route' => 'admin.configuration.feature-flags', 'permission' => 'configuration.view' ],
                [ 'title' => 'Secrets', 'route' => 'admin.configuration.secrets', 'permission' => 'configuration.view' ],
                [ 'title' => 'Environment Profiles', 'route' => 'admin.configuration.environment-profiles', 'permission' => 'configuration.view' ],
                [ 'title' => 'Version History', 'route' => 'admin.configuration.versions', 'permission' => 'configuration.view' ],
                [ 'title' => 'Rollbacks', 'route' => 'admin.configuration.rollbacks', 'permission' => 'configuration.view' ],
                [ 'title' => 'Changes', 'route' => 'admin.configuration.changes', 'permission' => 'configuration.view' ],
            ],
        ],
        [
            'title' => 'Governance',
            ...
            'sort' => 98,
            'children' => [
                [ 'title' => 'Overview', 'route' => 'admin.governance.dashboard', 'permission' => 'governance.view' ],
                [ 'title' => 'Policies', 'route' => 'admin.governance.policies', 'permission' => 'governance.view' ],
                [ 'title' => 'Compliance', 'route' => 'admin.governance.compliance', 'permission' => 'governance.view' ],
                [ 'title' => 'Risk Scores', 'route' => 'admin.governance.risk', 'permission' => 'governance.view' ],
                [ 'title' => 'SLA', 'route' => 'admin.governance.sla', 'permission' => 'governance.view' ],
                [ 'title' => 'Violations', 'route' => 'admin.governance.violations', 'permission' => 'governance.view' ],
                [ 'title' => 'Audits', 'route' => 'admin.governance.audits', 'permission' => 'governance.view' ],
                [ 'title' => 'Frameworks', 'route' => 'admin.governance.frameworks', 'permission' => 'governance.view' ],
            ],
        ],
        [
            'title' => 'HQ Central',
            ...
            'sort' => 99,
            'children' => [
                [ 'title' => 'Observability Dashboard', 'route' => 'admin.hq.observability.dashboard', 'permission' => 'hq.observability' ],
                [ 'title' => 'Logs', 'route' => 'admin.hq.observability.logs', 'permission' => 'hq.observability' ],
                [ 'title' => 'Metrics', 'route' => 'admin.hq.observability.metrics', 'permission' => 'hq.observability' ],
                [ 'title' => 'Traces', 'route' => 'admin.hq.observability.traces', 'permission' => 'hq.observability' ],
                [ 'title' => 'Health', 'route' => 'admin.hq.observability.health', 'permission' => 'hq.observability' ],
                [ 'title' => 'Security', 'route' => 'admin.hq.observability.security', 'permission' => 'hq.observability' ],
            ],
        ],
    ],
];
