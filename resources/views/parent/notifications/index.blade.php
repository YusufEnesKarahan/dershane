...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">Veli Bildirimleri</h2>
        <form action="{{ route('parent.notifications.read-all') }}" method="POST" class="d-inline">
            @csrf
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Öğrencinize Ait Bildirimler</h6>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <form action="{{ route('parent.notifications.read', $notif) }}" method="POST" class="d-inline">
                                        @csrf
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="text-center text-muted">Öğrencinizle ilgili bildirim bulunmuyor.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
