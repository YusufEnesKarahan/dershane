...
@section('title', 'Öğrenci Ders Programı')

@section('content')
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">Öğrenci Ders Programı</h2>
    </div>

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Öğrencinizin Ders Programı</h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="text-center text-muted">Öğrencinizin sınıfına ait ders programı bulunamadı.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
