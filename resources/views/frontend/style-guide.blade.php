...
@section('content')
    ...
    <x-container class="py-12 space-y-16">
        ...
        <!-- Section 1: Buttons -->
        <x-section bg="white" py="12" class="border border-slate-100 rounded-premium-2xl p-8 shadow-premium-sm">
            ...
            <div class="space-y-6">
                <!-- Variants -->
                <div class="space-y-2">
                    <h4 class="text-xs font-semibold text-slate/50 uppercase tracking-wider">Varyantlar (V1/V2/V3)</h4>
                ...
                <!-- Sizes -->
                <div class="space-y-2">
                    <h4 class="text-xs font-semibold text-slate/50 uppercase tracking-wider">Boyutlar (Sizes)</h4>
                    <div class="flex flex-wrap gap-3 items-center">
                ...
                <!-- States -->
                <div class="space-y-2">
                    <h4 class="text-xs font-semibold text-slate/50 uppercase tracking-wider">Durumlar (States)</h4>
                    <div class="flex flex-wrap gap-3 items-center">
        ...
        <x-section bg="white" py="12" class="border border-slate-100 rounded-premium-2xl p-8 shadow-premium-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Text Inputs -->
                <div class="space-y-4">
                    <h4 class="text-xs font-semibold text-slate/50 uppercase tracking-wider">Metin Alanları</h4>
                ...
                <!-- Textarea & Select -->
                <div class="space-y-4">
                    <h4 class="text-xs font-semibold text-slate/50 uppercase tracking-wider">Seçim ve Açıklama</h4>
            ...
            <div class="mt-8 pt-8 border-t border-slate-100 space-y-4">
                <h4 class="text-xs font-semibold text-slate/50 uppercase tracking-wider">Çoklu Seçim, Tekli Seçim ve Switch</h4>
        ...
        <x-section bg="white" py="12" class="border border-slate-100 rounded-premium-2xl p-8 shadow-premium-sm">
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-2 pt-4">
                    <h4 class="text-xs font-semibold text-slate/50 uppercase tracking-wider">Rozetler (Badges)</h4>
        ...
        <x-section bg="white" py="12" class="border border-slate-100 rounded-premium-2xl p-8 shadow-premium-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-4">
                    <h4 class="text-xs font-semibold text-slate/50 uppercase tracking-wider">Dropdown ve Modal Pencereleri</h4>
                    <div class="flex flex-wrap gap-3 items-center">
                        <!-- Dropdown -->
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                <a href="#" class="block px-4 py-2 text-xs text-slate hover:bg-slate-50 transition duration-150">Profili Düzenle</a>
                                <a href="#" class="block px-4 py-2 text-xs text-slate hover:bg-slate-50 transition duration-150">Şube Değiştir</a>
                    ...
                    <x-modal name="demo_modal" title="Örnek Detay Penceresi" size="md">
                        <p class="text-xs text-slate/70 leading-relaxed mb-4">
                ...
                <!-- FAQ Accordion -->
                <div class="space-y-4">
                    <h4 class="text-xs font-semibold text-slate/50 uppercase tracking-wider">Akordeon SSS (x-faq)</h4>
        ...
        <x-section bg="white" py="12" class="border border-slate-100 rounded-premium-2xl p-8 shadow-premium-sm">
            ...
            <div class="space-y-8">
                <!-- Stats -->
                <div class="space-y-4">
                    <h4 class="text-xs font-semibold text-slate/50 uppercase tracking-wider">İstatistik Göstergeleri (x-stats)</h4>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-slate-100">
                    <!-- Timeline -->
                    <div class="space-y-4">
                        <h4 class="text-xs font-semibold text-slate/50 uppercase tracking-wider">Kronolojik Yol Haritası (x-timeline)</h4>
                        <x-timeline :steps="$timelineSteps" />
                    </div>

                    <!-- Empty state -->
                    <div class="space-y-4">
                        <h4 class="text-xs font-semibold text-slate/50 uppercase tracking-wider">Boş Liste Görünümü (x-empty-state)</h4>
        ...
        <x-section bg="white" py="12" class="border border-slate-100 rounded-premium-2xl p-8 shadow-premium-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Spinners -->
                <div class="space-y-4">
                    <h4 class="text-xs font-semibold text-slate/50 uppercase tracking-wider">Dönen Yükleyiciler (x-spinner)</h4>
                ...
                <!-- Skeletons -->
                <div class="space-y-4">
                    <h4 class="text-xs font-semibold text-slate/50 uppercase tracking-wider">İskelet Yükleyiciler (x-skeleton)</h4>
                    <div class="space-y-3">
