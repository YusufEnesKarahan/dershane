...
@section('template-content')
    ...
    <x-section bg="dark" py="20" class="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-primary/20">
        <x-container class="relative z-10">
            ...
            <p class="text-slate-400 max-w-2xl text-lg">Öğrencilerimizi başarıya taşıyan kapsamlı ve hedefe yönelik müfredatımız.</p>
        </x-container>
    </x-section>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2 space-y-12">
                    <article class="prose prose-neutral max-w-none">
                        <h2 class="text-2xl font-bold font-display text-slate">Program Hakkında</h2>
                        <p class="text-slate/80 leading-relaxed">Bu eğitim programı, öğrencilerin akademik hedeflerine ulaşmaları için özel olarak tasarlanmıştır. Yüksek başarı oranımız, uzman kadromuz ve modern eğitim materyallerimizle geleceğinizi şekillendiriyoruz.</p>
                        
                        <h3 class="text-xl font-bold font-display text-slate mt-8">Müfredat İçeriği</h3>
                        <ul class="space-y-4 mt-4">
                            <li class="flex items-start">
                                ...
                                <span class="text-slate/80">Kapsamlı Konu Anlatımları ve Soru Çözüm Stratejileri</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-6 w-6 text-primary shrink-0 mr-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                <span class="text-slate/80">Yeni Nesil Sorulara Uygun Deneme Sınavları (Her Hafta)</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-6 w-6 text-primary shrink-0 mr-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                <span class="text-slate/80">Birebir Mentorluk ve Veli Bilgilendirme Sistemi</span>
                            </li>
                        </ul>
                    </article>
                </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-slate-50 rounded-premium-2xl border border-slate-100 p-6 shadow-premium-sm sticky top-8">
                        <h3 class="text-xl font-bold font-display text-slate mb-4">Hemen Başvurun</h3>
                        <p class="text-sm text-slate/70 mb-6">Erken kayıt avantajlarından ve özel indirimlerden yararlanmak için ön kayıt formunu doldurun.</p>
                        ...
                        <div class="mt-6 pt-6 border-t border-slate-200">
                            <h4 class="text-sm font-bold text-slate mb-3">Programa Dahil Olanlar</h4>
