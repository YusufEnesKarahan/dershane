...
<div class="container-fluid">
    <h2 class="h3 mb-4 text-slate-800">Ödemelerim</h2>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                Toplam Borç</div>
                            <div class="h5 mb-0 font-weight-bold text-slate-800">{{ number_format($summary['total_debt'], 2) }} ₺</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Ödenen</div>
                            <div class="h5 mb-0 font-weight-bold text-slate-800">{{ number_format($summary['net_paid'], 2) }} ₺</div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-check-circle fa-2x text-slate-300"></i>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                Kalan Borç</div>
                            <div class="h5 mb-0 font-weight-bold text-slate-800">{{ number_format($summary['remaining_debt'], 2) }} ₺</div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-hourglass-half fa-2x text-slate-300"></i>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Gecikmiş</div>
                            <div class="h5 mb-0 font-weight-bold text-slate-800">{{ number_format($summary['overdue_amount'], 2) }} ₺</div>
                        </div>
                        <div class="col-auto">
