...
<div {{ $attributes->merge(['class' => 'bg-gradient-to-br from-slate-900 via-slate-800 to-primary/30 text-white rounded-premium-2xl p-8 sm:p-12 relative overflow-hidden border border-slate-800 shadow-premium-xl']) }}>
    <!-- Subtle grid overlay -->
    ...
    <div class="max-w-3xl relative z-10 space-y-6">
        ...
        <p class="text-xs sm:text-sm text-slate-300 font-sans leading-relaxed max-w-xl">
            {{ $subtitle }}
        </p>
