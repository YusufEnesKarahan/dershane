...
<div class="bg-gradient-to-br from-slate-900 via-slate-800 to-primary/20 text-white py-24 px-6 relative overflow-hidden">
    <!-- Subtle grid overlay -->
    ...
    <div class="max-w-4xl mx-auto text-center relative z-10 space-y-6">
        <h1 class="text-4xl sm:text-6xl font-display font-extrabold tracking-tight leading-none bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-slate-200">
            {{ $title }}
        </h1>
        <p class="text-base sm:text-lg text-slate-300 font-sans max-w-2xl mx-auto leading-relaxed">
            {{ $subtitle }}
        </p>
