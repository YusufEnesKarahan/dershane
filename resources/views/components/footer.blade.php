<footer class="bg-white border-t border-slate-100 font-sans mt-auto">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="md:col-span-2 space-y-4">
                ...
                <p class="text-xs text-slate/50 max-w-sm leading-relaxed">
            ...
            <!-- Links 1 -->
            <div>
                <h4 class="text-xs font-semibold text-slate uppercase tracking-wider select-none">Kurumsal</h4>
                <ul class="mt-4 space-y-2 text-xs text-slate/60">
            ...
            <!-- Links 2 -->
            <div>
                <h4 class="text-xs font-semibold text-slate uppercase tracking-wider select-none">İletişim</h4>
                <ul class="mt-4 space-y-2 text-xs text-slate/60">
        ...
        <!-- Copyright -->
        <div class="mt-12 pt-8 border-t border-slate-100 flex items-center justify-between text-xs text-slate/40">
