                ...
                <div class="relative z-10 flex items-start justify-between">
                    <div>
                        ...
                        <div class="text-3xl font-black text-slate-900 dark:text-white flex items-baseline gap-1">
                            {{ $totalClassrooms }} <span class="text-xs font-semibold text-slate-500 dark:text-slate-400">Fiziki Sınıf</span>
                        </div>
                    </div>
            ...
            <div class="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm relative overflow-hidden group hover:border-blue-500/30 transition-colors">
                ...
                <div class="relative z-10 flex items-start justify-between">
                    <div>
                        ...
                        <div class="text-3xl font-black text-slate-900 dark:text-white flex items-baseline gap-1">
                            {{ $totalCapacity }} <span class="text-xs font-semibold text-slate-500 dark:text-slate-400">Öğrenci</span>
                        </div>
                    </div>
                    <div class="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl text-slate-400 dark:text-slate-500">
