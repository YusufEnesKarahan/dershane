                    ...
                    <div class="p-6 flex-1">
                        <x-admin.form.layout :action="route('admin.classrooms.holidays.store')" method="POST">
                            <x-admin.form.field-group label="Tatil Adı" id="name" required>
                                <input type="text" name="name" id="name" required placeholder="Örn: 29 Ekim Cumhuriyet Bayramı" class="w-full bg-white dark:bg-neutral-900 border-neutral-300 dark:border-neutral-700 rounded-xl shadow-sm focus:ring-primary focus:border-primary sm:text-sm text-neutral-900 dark:text-white transition-colors">
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-800">
                                    <thead class="bg-neutral-50/80 dark:bg-neutral-900/80 backdrop-blur-sm">
                                        <tr>
                                            <th class="px-6 py-4 text-left text-xs font-bold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider bg-neutral-50/50 dark:bg-neutral-800/30">Tatil Adı</th>
                                    ...
                                    <tbody class="divide-y divide-neutral-100 dark:divide-neutral-800/50 bg-white dark:bg-neutral-900">
                                        @foreach($holidays as $holiday)
                                            <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-800/40 transition-colors border-b border-neutral-100 dark:border-neutral-800/50 last:border-0 group">
                                                <td class="px-6 py-4">
                                                <div class="text-sm font-bold text-neutral-900 dark:text-white">{{ $holiday->name }}</div>
                                            </td>
                                            <td class="px-6 py-4">
