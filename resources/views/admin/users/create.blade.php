        ...
        <div class="max-w-2xl bg-white dark:bg-neutral-900 p-6 rounded-2xl border border-neutral-100 dark:border-neutral-800 shadow-sm">
            <x-admin.form.layout :action="route('admin.users.store')" method="POST">
                <x-admin.form.field-group label="Tam Adı" id="name" :error="$errors->first('name')">
                    <input type="text" name="name" id="name" required class="w-full text-sm bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-xl px-3 py-2.5 text-neutral-800 dark:text-neutral-200">
                </x-admin.form.field-group>

                <x-admin.form.field-group label="E-Posta" id="email" :error="$errors->first('email')">
                    <input type="email" name="email" id="email" required class="w-full text-sm bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-xl px-3 py-2.5 text-neutral-800 dark:text-neutral-200">
                </x-admin.form.field-group>
                ...
                <x-admin.form.field-group label="Telefon" id="phone" :error="$errors->first('phone')">
                    <input type="text" name="phone" id="phone" class="w-full text-sm bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-xl px-3 py-2.5 text-neutral-800 dark:text-neutral-200">
                </x-admin.form.field-group>
