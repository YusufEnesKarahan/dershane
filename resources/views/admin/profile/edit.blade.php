                ...
                <div x-show="tab === 'security'" x-transition>
                    <x-admin.form.layout :action="route('admin.profile.password')" method="POST">
                        <x-admin.form.field-group label="Mevcut Şifre" id="current_password" :error="$errors->first('current_password')">
                            <input type="password" name="current_password" id="current_password" required class="w-full text-sm bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-xl px-3 py-2.5 text-neutral-800 dark:text-neutral-200">
                        </x-admin.form.field-group>

                        <x-admin.form.field-group label="Yeni Şifre" id="password" :error="$errors->first('password')">
                            <input type="password" name="password" id="password" required class="w-full text-sm bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-xl px-3 py-2.5 text-neutral-800 dark:text-neutral-200">
                        </x-admin.form.field-group>

                        <x-admin.form.field-group label="Yeni Şifre (Onayla)" id="password_confirmation" :error="$errors->first('password_confirmation')">
                            <input type="password" name="password_confirmation" id="password_confirmation" required class="w-full text-sm bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-xl px-3 py-2.5 text-neutral-800 dark:text-neutral-200">
                        </x-admin.form.field-group>
                ...
                <div x-show="tab === 'preferences'" x-transition>
                    <x-admin.form.layout :action="route('admin.preferences.update')" method="POST">
                        <x-admin.form.field-group label="Tema Tercihi" id="theme" :error="$errors->first('theme')">
                            <select name="theme" id="theme" class="w-full text-sm bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-xl px-3 py-2.5 text-neutral-800 dark:text-neutral-200">
                        ...
                        <x-admin.form.field-group label="Dil" id="language" :error="$errors->first('language')">
                            <select name="language" id="language" class="w-full text-sm bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-xl px-3 py-2.5 text-neutral-800 dark:text-neutral-200">
                        ...
                        <x-admin.form.field-group label="Zaman Dilimi" id="timezone" :error="$errors->first('timezone')">
                            <input type="text" name="timezone" id="timezone" value="{{ $user->preferredTimezone() }}" class="w-full text-sm bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-xl px-3 py-2.5 text-neutral-800 dark:text-neutral-200">
                        </x-admin.form.field-group>
                ...
                <div x-show="tab === 'avatar'" x-transition>
                    <x-admin.form.layout :action="route('admin.profile.avatar')" method="POST" enctype="multipart/form-data">
                        ...
                        <x-admin.form.field-group label="Profil Resmi Seç" id="avatar" :error="$errors->first('avatar')">
                            <input type="file" name="avatar" id="avatar" class="w-full text-sm bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-xl px-3 py-2.5 text-neutral-800 dark:text-neutral-200">
                        </x-admin.form.field-group>
