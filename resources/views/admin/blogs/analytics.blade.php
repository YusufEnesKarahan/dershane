    ...
    <x-admin.crud.index-layout title="İçerik İstatistik Raporları" description="Yazılarınızın okunma sayılarını, tıklama ve yorum etkileşimlerini analiz edin.">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white dark:bg-neutral-900 p-6 rounded-2xl border border-neutral-100 dark:border-neutral-800 shadow-sm">
                ...
                <div class="text-2xl font-black text-neutral-900 dark:text-white">14,250</div>
                <div class="text-[11px] font-medium text-emerald-600 dark:text-emerald-500 mt-1">▲ %12.4 (Geçen haftaya göre)</div>
            </div>
            <div class="bg-white dark:bg-neutral-900 p-6 rounded-2xl border border-neutral-100 dark:border-neutral-800 shadow-sm">
                <h4 class="text-xs font-bold text-neutral-400 uppercase tracking-wider mb-2">Tekil Ziyaretçiler</h4>
                <div class="text-2xl font-black text-neutral-900 dark:text-white">8,920</div>
                <div class="text-[11px] font-medium text-emerald-600 dark:text-emerald-500 mt-1">▲ %8.2 (Geçen haftaya göre)</div>
            </div>
            <div class="bg-white dark:bg-neutral-900 p-6 rounded-2xl border border-neutral-100 dark:border-neutral-800 shadow-sm">
                <h4 class="text-xs font-bold text-neutral-400 uppercase tracking-wider mb-2">Ortalama Hemen Çıkma (Bounce)</h4>
                <div class="text-2xl font-black text-neutral-900 dark:text-white">%34.5</div>
                <div class="text-[11px] font-medium text-emerald-600 dark:text-emerald-500 mt-1">▼ -%2.1 (Düşüş iyiye işarettir)</div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-neutral-900 p-6 rounded-2xl border border-neutral-100 dark:border-neutral-800 shadow-sm">
            ...
            <x-admin.table.layout>
                <x-slot name="head">
                    ...
                    <th class="px-6 py-4 text-left text-xs font-bold text-neutral-500 uppercase tracking-wider">Okunma Sayısı</th>
                    <th class="px-6 py-4 text-left text-xs font-bold text-neutral-500 uppercase tracking-wider">Yorumlar</th>
                </x-slot>
                <x-slot name="body">
