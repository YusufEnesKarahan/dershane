...
@section('template-content')
    <x-section bg="gray" py="24" class="min-h-screen flex items-center justify-center">
        <div class="text-center">
            <h1 class="text-4xl font-display font-bold text-slate mb-4">Yönetim Paneli</h1>
            <p class="text-slate-500 mb-8">Gelecek sprintlerde bu alana Admin Dashboard inşa edilecektir.</p>
