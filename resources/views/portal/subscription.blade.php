...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-2">Manage your current plan, billing cycles, and invoices.</p>
    </div>

    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        <!-- Current Plan -->
        <div class="bg-white rounded-lg shadow p-6">
            <h3 class="text-lg font-semibold text-gray-700 mb-4 border-b pb-2">Current Plan</h3>
            @if($subscription)
                <div class="flex justify-between items-center mb-4">
                    <div>
                        <p class="text-2xl font-bold text-gray-900">{{ $subscription['plan_name'] }}</p>
                        <p class="text-sm text-gray-500">Status: <span class="font-semibold text-green-600">{{ ucfirst($subscription['status']) }}</span></p>
                    </div>
            ...
            @else
                <p class="text-gray-500">You do not have an active subscription.</p>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <h3 class="text-lg font-semibold text-gray-700 mb-4 border-b pb-2">Payment Method</h3>
            <div class="flex items-center space-x-4">
                <div class="bg-gray-100 p-3 rounded">
                    <svg class="w-8 h-8 text-gray-500" fill="currentColor" viewBox="0 0 24 24"><path d="M20 4H4C2.89 4 2.01 4.89 2.01 6L2 18C2 19.11 2.89 20 4 20H20C21.11 20 22 19.11 22 18V6C22 4.89 21.11 4 20 4ZM20 18H4V12H20V18ZM20 8H4V6H20V8Z"/></svg>
                </div>
                <div>
                    <p class="text-gray-900 font-medium">Visa ending in **** 4242</p>
                    <p class="text-sm text-gray-500">Expires 12/28</p>
                </div>
            </div>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-800">Billing History</h3>
        </div>
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">#{{ substr($invoice->uuid, 0, 8) }}</td>
