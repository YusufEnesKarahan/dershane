...
```
# Release Strategy
- Branches: main for active development.
- Tags: basic-v1.x, professional-v1.x, ultimate-v1.x for edition releases.
No separate branches are needed; the edition feature flag system controls the features.
