...
class TenantProvisioningService
{
    ...
    public function __construct(SubscriptionService $subscriptionService, AuditService $auditService)
    {
        $this->subscriptionService = $subscriptionService;
        $this->auditService = $auditService;
    }

    public function createTenant(array $data): Institution
    {
        $tenant = Institution::create([
            'name' => $data['name'],
    ...
    public function createAdminUser(Institution $tenant, array $data): User
    {
    ...
    public function setupBilling(Institution $tenant, HQPlan $plan)
    {
    ...
    public function createDefaultConfig(Institution $tenant)
    {
    ...
    public function setupIAM(Institution $tenant)
    {
    ...
    public function activatePortal(Institution $tenant)
    {
