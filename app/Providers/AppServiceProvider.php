...
use App\Domain\Billing\Gateways\FakePaymentGateway;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(\App\Models\User::class, \App\Policies\UserManagementPolicy::class);
        Gate::policy(\App\Domain\Institution\Models\InstitutionSetting::class, \App\Policies\InstitutionSettingPolicy::class);
